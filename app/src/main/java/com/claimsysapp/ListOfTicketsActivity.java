...
import com.claimsysapp.fragments.ListOfTicketsFragments;
...
public class ListOfTicketsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void initializeComponents() {
        ...
        currUserImage.setImageDrawable(Globals.ImageMethods.getRoundImage(ListOfTicketsActivity.this, Globals.currentUser.getUserName()));
